...
import enrollmentsystem.gui.dialog.au.JDialogCivilStatusAU;
 ...
 */
public class JDialogCivilStatus extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogCivilStatus(enrollmentsystem.gui.JFrameEnrollment parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(528, 332));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        JDialogCivilStatusAU uau = new JDialogCivilStatusAU(mainFrame, true);
        uau.setVisible(true);
        selectCivilStatus();
    }//GEN-LAST:event_jButtonAddActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogCivilStatusAU uau = new JDialogCivilStatusAU(mainFrame, true, civilStatus);
        uau.setVisible(true);
        selectCivilStatus();
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogCivilStatusAU uau = new JDialogCivilStatusAU(mainFrame, civilStatus, true);
        uau.setVisible(true);
        selectCivilStatus();
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        String civilStatusl = jTable1.getValueAt(row, 1).toString();
                        CivilStatus cs = new CivilStatus(idl, civilStatusl);
                        this.civilStatus = cs;
                    }
                }
            }
...
//            header.setBackground(new java.awt.Color(153, 153, 153));
    ...
    private void selectCivilStatus() {
        List<enrollmentsystem.records.CivilStatus> studentList = new AppQuery().getCivilStatus();
        tableModel.setRowCount(0);
        for (enrollmentsystem.records.CivilStatus c : studentList) {
            tableModel.addRow(new Object[]{c.id(), c.civilStatus()});
        }
    }
}
