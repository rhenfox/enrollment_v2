...
import enrollmentsystem.gui.dialog.au.JDialogRoleAU;
...
public class JDialogRole extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogRole(enrollmentsystem.gui.JFrameEnrollment parent, boolean modal) {
        super(parent, modal);
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        JDialogRoleAU uau = new JDialogRoleAU(mainFrame, true);
        uau.setVisible(true);
        selectRole();
    }//GEN-LAST:event_jButtonAddActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogRoleAU uau = new JDialogRoleAU(mainFrame, true, role);
        uau.setVisible(true);
        selectRole();
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogRoleAU uau = new JDialogRoleAU(mainFrame, role, true);
        uau.setVisible(true);
        selectRole();
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        String rolel = jTable1.getValueAt(row, 1).toString();
                        Boolean mUserl = Boolean.parseBoolean(jTable1.getValueAt(row, 2).toString());
                        Boolean mRegisterl = Boolean.parseBoolean(jTable1.getValueAt(row, 3).toString());
                        Boolean mClassOfferl = Boolean.parseBoolean(jTable1.getValueAt(row, 4).toString());
                        Role role = new Role(idl, rolel, mUserl, mRegisterl, mClassOfferl);
                        this.role = role;
                    }
                }
            }
    ...
    private void setTable() {
        try {
            String[] columnNames = {
                "Id",//
                "Role",
                "<html><center>MANAGE<br> USER</center></html>",
                "<html><center>MANAGE<br> REGISTRATION</center></html>",
                "<html><center>MANAGE<br> CLASS OFFER</center></html>"
            };//15
...
//            header.setBackground(new java.awt.Color(153, 153, 153));
    ...
    private void selectRole() {
        List<enrollmentsystem.records.Role> roleList = new AppQuery().getRole();
        tableModel.setRowCount(0);
        for (enrollmentsystem.records.Role r : roleList) {
            tableModel.addRow(new Object[]{r.id(), r.role(), r.mUser(), r.mRegister(), r.mSubjectOffer()});
        }
    }
}
