...
import enrollmentsystem.gui.dialog.au.JDialogSubjectAU;
...
public class JDialogSubject extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogSubject(enrollmentsystem.gui.JFrameEnrollment parent, boolean modal) {
        super(parent, modal);
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        JDialogSubjectAU uau = new JDialogSubjectAU(mainFrame, true);
        uau.setVisible(true);
        selectSubject();
    }//GEN-LAST:event_jButtonAddActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogSubjectAU uau = new JDialogSubjectAU(mainFrame, true, subject);
        uau.setVisible(true);
        selectSubject();
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogSubjectAU uau = new JDialogSubjectAU(mainFrame, subject, true);
        uau.setVisible(true);
        selectSubject();
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        Integer unitIDl = Integer.parseInt(jTable1.getValueAt(row, 1).toString());
                        Integer courseIDl = Integer.parseInt(jTable1.getValueAt(row, 2).toString());
                        String codel = jTable1.getValueAt(row, 4).toString();
                        String subjectl = jTable1.getValueAt(row, 5).toString();
                        Integer unitsl = Integer.parseInt(jTable1.getValueAt(row, 6).toString());
                        Unit unit = new Unit(unitIDl, unitsl);
                        Course course = new Course(courseIDl, codel, codel);
                        Subject subject = new Subject(idl, course, codel, subjectl, unit);
...
//            header.setBackground(new java.awt.Color(153, 153, 153));
            ...
            column[5].setPreferredWidth(360);
    ...
    private void selectSubject() {
        List<enrollmentsystem.records.Subject> subjectList = new AppQuery().getSubject();
        tableModel.setRowCount(0);
        for (enrollmentsystem.records.Subject s : subjectList) {
            tableModel.addRow(new Object[]{s.id(), s.units().id(),s.course().id(), s.course().acronym(), s.code(), s.subject(), s.units().unit()});
        }
    }
