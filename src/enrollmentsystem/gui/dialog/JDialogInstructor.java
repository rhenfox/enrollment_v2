...
import enrollmentsystem.gui.dialog.au.JDialogInstructorAU;
 ...
 */
public class JDialogInstructor extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogInstructor(enrollmentsystem.gui.JFrameEnrollment parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(1010, 467));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        JDialogInstructorAU uau = new JDialogInstructorAU(mainFrame, true);
        uau.setVisible(true);
        selectInstructor();
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogInstructorAU uau = new JDialogInstructorAU(mainFrame, true, this.instructor);
        uau.setVisible(true);
        selectInstructor();
    }//GEN-LAST:event_jButtonUpdateActionPerformed

    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogInstructorAU uau = new JDialogInstructorAU(mainFrame, this.instructor, true);
        uau.setVisible(true);
        selectInstructor();
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        String studentl = jTable1.getValueAt(row, 1).toString();
                        String firstnamel = jTable1.getValueAt(row, 2).toString();
                        String middlenamel = jTable1.getValueAt(row, 3).toString();
                        String lastnamel = jTable1.getValueAt(row, 4).toString();
                        String genderl = jTable1.getValueAt(row, 5).toString();

                        Integer civilStatusIDl = Integer.parseInt(jTable1.getValueAt(row, 6).toString());
                        String civilStatusl = jTable1.getValueAt(row, 7).toString();
                        String dateOfBirthl = jTable1.getValueAt(row, 8).toString();

                        String mobilel = jTable1.getValueAt(row, 9).toString();
                        String addressl = jTable1.getValueAt(row, 10).toString();
                        String emaill = jTable1.getValueAt(row, 11).toString();
                        CivilStatus civilStatus = new CivilStatus(civilStatusIDl, civilStatusl);
                        Instructor instructor = new Instructor(idl, firstnamel, middlenamel, lastnamel, genderl, civilStatus, dateOfBirthl, mobilel, emaill, addressl, null);
...
//                       
    ...
    private void setTable() {
        try {
            String[] columnNames = {
                //        studentid ,courseId,instructor , course,firstname,middlename,lastname,  
...
//            TableColumn hidden6 = jTable1.getColumnModel().getColumn(8);
//            hidden6.setMinWidth(0);
//            hidden6.setPreferredWidth(0);
//            hidden6.setMaxWidth(0);
//            TableColumn hidden7 = jTable1.getColumnModel().getColumn(9);
//            hidden7.setMinWidth(0);
//            hidden7.setPreferredWidth(0);
//            hidden7.setMaxWidth(0);
//            TableColumn hidden8 = jTable1.getColumnModel().getColumn(10);
//            hidden8.setMinWidth(0);
//            hidden8.setPreferredWidth(0);
//            hidden8.setMaxWidth(0);
//            TableColumn hidden9 = jTable1.getColumnModel().getColumn(11);
...
//            hidden9.setMaxWidth(0);
    ...
    private void selectInstructor() {
        List<enrollmentsystem.records.Instructor> instructorList = new AppQuery().getInstructor();
        tableModel.setRowCount(0);
        for (enrollmentsystem.records.Instructor ins : instructorList) {
            String instructor = ins.lastname() + "," + ins.firstname() + " " + ins.middlename().substring(0, 1) + ".";
            tableModel.addRow(new Object[]{ins.id(), instructor, ins.firstname(), ins.middlename(), ins.lastname(), ins.gender(), ins.civilStatus().id(), ins.civilStatus().civilStatus(), ins.dateOfBirth(), ins.mobileNo(), ins.email(), ins.address()});
        }
    }
}
