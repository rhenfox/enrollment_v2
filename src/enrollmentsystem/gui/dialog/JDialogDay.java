...
import enrollmentsystem.gui.dialog.au.JDialogDayAU;
...
public class JDialogDay extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogDay(enrollmentsystem.gui.JFrameEnrollment parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(529, 467));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        JDialogDayAU uau = new JDialogDayAU(mainFrame, true);
        uau.setVisible(true);
        selectDay();
    }//GEN-LAST:event_jButtonAddActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogDayAU uau = new JDialogDayAU(mainFrame, true, day);
        uau.setVisible(true);
        selectDay();
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogDayAU uau = new JDialogDayAU(mainFrame, day, true);
        uau.setVisible(true);
        selectDay();
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        String dayl = jTable1.getValueAt(row, 1).toString();
                        String description = jTable1.getValueAt(row, 2).toString();
                        Day course = new Day(idl, dayl, description);
                        this.day = course;
                    }
                }
            }
...
//            header.setBackground(new java.awt.Color(153, 153, 153));
            ...
            column[1].setPreferredWidth(120);
    ...
    private void selectDay() {
        List<enrollmentsystem.records.Day> studentList = new AppQuery().getDay();
        tableModel.setRowCount(0);
        for (enrollmentsystem.records.Day d : studentList) {
            tableModel.addRow(new Object[]{d.id(), d.day(), d.description()});
        }
    }
}
