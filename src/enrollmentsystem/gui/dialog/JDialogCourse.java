...
public class JDialogCourse extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogCourse(enrollmentsystem.gui.JFrameEnrollment parent, boolean modal) {
        super(parent, modal);
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        JDialogCourseAU uau = new JDialogCourseAU(mainFrame, true);
        uau.setVisible(true);
        selectCourse();
    }//GEN-LAST:event_jButtonAddActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogCourseAU uau = new JDialogCourseAU(mainFrame, true, course);
        uau.setVisible(true);
        selectCourse();
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogCourseAU uau = new JDialogCourseAU(mainFrame, course, true);
        uau.setVisible(true);
        selectCourse();
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        String coursel = jTable1.getValueAt(row, 1).toString();
                        String acronyml = jTable1.getValueAt(row, 2).toString();
                        Course course = new Course(idl, coursel, acronyml);
                        this.course = course;
                    }
                }
            }
...
//            header.setBackground(new java.awt.Color(153, 153, 153));
    ...
    private void selectCourse() {
        List<enrollmentsystem.records.Course> studentList = new AppQuery().getCourse();
        tableModel.setRowCount(0);
        for (enrollmentsystem.records.Course c : studentList) {
            tableModel.addRow(new Object[]{c.id(), c.course(), c.acronym()});
        }
    }
}
