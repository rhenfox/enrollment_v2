...
import enrollmentsystem.gui.dialog.au.JDialogTuitionFeeAU;
 ...
 */
public class JDialogTuitionFee extends javax.swing.JDialog implements MouseListener {

    /**
     * Creates new form JDialogUser
     */
    private JFrameEnrollment mainFrame;
    private TuitionFee tutitonFee;

    public JDialogTuitionFee(enrollmentsystem.gui.JFrameEnrollment parent, boolean modal) {
        super(parent, modal);
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        JDialogTuitionFeeAU uau = new JDialogTuitionFeeAU(mainFrame, true);
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        if (tutitonFee.id() < 1) {
            JOptionPane.showMessageDialog(mainFrame, tutitonFee.tuitionFee() + " is no major created.", "WARNING!!!", JOptionPane.WARNING_MESSAGE);
            return;
        } else {
            JDialogTuitionFeeAU tf = new JDialogTuitionFeeAU(mainFrame, true, tutitonFee);
            tf.setVisible(true);
            selectTuitionFee();
        }
        jButtonUpdate.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        if (tutitonFee.id() < 1) {
            ...
            JDialogTuitionFeeAU tf = new JDialogTuitionFeeAU(mainFrame, tutitonFee, true);
            tf.setVisible(true);
            selectTuitionFee();
        }
        jButtonUpdate.setEnabled(false);
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        SchoolYear c = new SchoolYear(majorIdl, coursel, null, fil, fil);
                        TuitionFee courseMajor = new TuitionFee(majorIdl, TOP_ALIGNMENT, c);
                        this.tutitonFee = courseMajor;
                    }
                }
            }
        }
...
//            header.setBackground(new java.awt.Color(153, 153, 153));
    ...
    private void selectTuitionFee() {
        List<enrollmentsystem.records.TuitionFee> courseMajorList = new AppQuery().getTuitionFee();
        tableModel.setRowCount(0);
        for (enrollmentsystem.records.TuitionFee tf : courseMajorList) {
            tableModel.addRow(new Object[]{tf.id(), tf.schoolYear().id(), tf.schoolYear().schoolYear(), tf.tuitionFee()});
        }
    }
