...
import enrollmentsystem.gui.dialog.au.JDialogSemesterAU;
 ...
 */
public class JDialogSemester extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogSemester(enrollmentsystem.gui.JFrameEnrollment parent, boolean modal) {
        super(parent, modal);
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        JDialogSemesterAU uau = new JDialogSemesterAU(mainFrame, true);
        uau.setVisible(true);
        selectSchoolYear();
    }//GEN-LAST:event_jButtonAddActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogSemesterAU uau = new JDialogSemesterAU(mainFrame, true, semester);
        uau.setVisible(true);
        selectSchoolYear();
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogSemesterAU uau = new JDialogSemesterAU(mainFrame, semester, true);
        uau.setVisible(true);
        selectSchoolYear();
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        String semesterl = jTable1.getValueAt(row, 1).toString();
                        Semester sy = new Semester(idl, semesterl);
                        this.semester = sy;
                    }
                }
            }
...
//            header.setBackground(new java.awt.Color(153, 153, 153));
    ...
    private void selectSchoolYear() {
        List<enrollmentsystem.records.Semester> syList = new AppQuery().getSemester();
        tableModel.setRowCount(0);
        for (enrollmentsystem.records.Semester sy : syList) {
            tableModel.addRow(new Object[]{sy.id(), sy.semester()});
        }
    }
}
