...
import enrollmentsystem.gui.dialog.au.JDialogSchoolYearAU;
...
public class JDialogSchoolYear extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogSchoolYear(enrollmentsystem.gui.JFrameEnrollment parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(629, 467));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        JDialogSchoolYearAU uau = new JDialogSchoolYearAU(mainFrame, true);
        uau.setVisible(true);
        selectSchoolYear();
    }//GEN-LAST:event_jButtonAddActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogSchoolYearAU uau = new JDialogSchoolYearAU(mainFrame, true, schoolYear);
        uau.setVisible(true);
        selectSchoolYear();
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogSchoolYearAU uau = new JDialogSchoolYearAU(mainFrame, schoolYear, true);
        uau.setVisible(true);
        selectSchoolYear();
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        Integer semesterIdl = Integer.parseInt(jTable1.getValueAt(row, 1).toString());
                        String schoolYearl = jTable1.getValueAt(row, 2).toString();
                        String semesterl = jTable1.getValueAt(row, 3).toString();
                        String startl = jTable1.getValueAt(row, 4).toString();
                        String endl = jTable1.getValueAt(row, 5).toString();
                        Semester semester = new Semester(semesterIdl, semesterl);
                        SchoolYear sy = new SchoolYear(idl, schoolYearl, semester, startl, endl);
                        this.schoolYear = sy;
                    }
                }
            }
...
//            header.setBackground(new java.awt.Color(153, 153, 153));
            ...
            column[1] = jTable1.getColumnModel().getColumn(3);
    ...
    private void selectSchoolYear() {
        List<enrollmentsystem.records.SchoolYear> syList = new AppQuery().getSchoolYear();
        tableModel.setRowCount(0);
        for (enrollmentsystem.records.SchoolYear sy : syList) {
            Date start = new Date(Integer.parseInt(sy.start().toString().substring(0, 4)) - 1900, Integer.parseInt(sy.start().toString().substring(5, 7)) - 1, Integer.parseInt(sy.start().substring(8)));
            Date end = new Date(Integer.parseInt(sy.end().toString().substring(0, 4)) - 1900, Integer.parseInt(sy.end().toString().substring(5, 7)) - 1, Integer.parseInt(sy.end().substring(8)));
            String pattern = "MMM dd, yyyy";
            SimpleDateFormat simpleDateFormat = new SimpleDateFormat(pattern);
            String sDate = simpleDateFormat.format(start);
            String eDate = simpleDateFormat.format(end);
            tableModel.addRow(new Object[]{sy.id(), sy.semester().id(), sy.schoolYear(), sy.semester().semester(), sy.start(), sy.end(), sDate, eDate});
        }
    }
}
