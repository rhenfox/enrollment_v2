...
public class JDialogTime extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogTime(enrollmentsystem.gui.JFrameEnrollment parent, boolean modal) {
        super(parent, modal);
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        JDialogTimeAU uau = new JDialogTimeAU(mainFrame, true);
        uau.setVisible(true);
        selectTime();
    }//GEN-LAST:event_jButtonAddActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogTimeAU uau = new JDialogTimeAU(mainFrame, true, time);
        uau.setVisible(true);
        selectTime();
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogTimeAU uau = new JDialogTimeAU(mainFrame, time, true);
        uau.setVisible(true);
        selectTime();
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        Integer dayIDl = Integer.parseInt(jTable1.getValueAt(row, 1).toString());
                        String dayl = jTable1.getValueAt(row, 2).toString();
                        String timel = jTable1.getValueAt(row, 3).toString();
                        Day day = new Day(dayIDl, dayl, dayl);
                        Time time = new Time(idl, day, timel);
                        this.time = time;
                    }
                }
            }
...
//            header.setBackground(new java.awt.Color(153, 153, 153));
    ...
    private void selectTime() {
        List<enrollmentsystem.records.Time> timeList = new AppQuery().getTime();
        tableModel.setRowCount(0);
        for (enrollmentsystem.records.Time t : timeList) {
            tableModel.addRow(new Object[]{t.id(), t.day().id(), t.day().day(), t.time()});
        }
    }
}
