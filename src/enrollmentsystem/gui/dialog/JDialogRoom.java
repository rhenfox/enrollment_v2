...
import enrollmentsystem.gui.dialog.au.JDialogRoomAU;
 ...
 */
public class JDialogRoom extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogRoom(enrollmentsystem.gui.JFrameEnrollment parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(566, 467));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        JDialogRoomAU uau = new JDialogRoomAU(mainFrame, true);
        uau.setVisible(true);
        selectRoom();
    }//GEN-LAST:event_jButtonAddActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogRoomAU uau = new JDialogRoomAU(mainFrame, true, room);
        uau.setVisible(true);
        selectRoom();
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogRoomAU uau = new JDialogRoomAU(mainFrame, room, true);
        uau.setVisible(true);
        selectRoom();
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        String rooml = jTable1.getValueAt(row, 1).toString();
                        String locationl = jTable1.getValueAt(row, 2).toString();
                        Room room = new Room(idl, rooml, locationl);
                        this.room = room;
                    }
                }
            }
...
//            header.setBackground(new java.awt.Color(153, 153, 153));
            ...
            column[2].setPreferredWidth(320);
    ...
    private void selectRoom() {
        List<enrollmentsystem.records.Room> studentList = new AppQuery().getRooms();
        tableModel.setRowCount(0);
        for (enrollmentsystem.records.Room c : studentList) {
            tableModel.addRow(new Object[]{c.id(), c.room(), c.location()});
        }
    }
}
